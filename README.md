# My agent — personal AI butler

音声で対話するAI執事を中核に、**キャラクター動画演出・顔/パスワード認証・Obsidianナレッジ参照（RAG）・Web検索・カレンダー連携**までを統合した、**スマートフォン最優先（PWA）** のパーソナルAIアシスタント。
