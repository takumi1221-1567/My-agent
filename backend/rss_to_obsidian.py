...
依存: feedparser, requests（AINAS venv に導入済み）

実行: python3 ~/RET/backend/rss_to_obsidian.py
cron: 0 7 * * *  python3 ~/My-agent/backend/rss_to_obsidian.py >> /tmp/ainas_rss.log 2>&1
"""
